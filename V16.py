                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('first564last')
                                        plist.append('first321last')
                                        plist.append('first111last')
                                        plist.append('first12last')
                                        plist.append('first777last')
                                        plist.append('first123last')
                                        plist.append('first1234last')
                                        plist.append('first12345last')
                                        plist.append('first123456last')
                                elif ppp in ['3','03']:
